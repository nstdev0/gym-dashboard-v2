...
// Extend the schema for form usage if needed, but the DTO schema should suffice
                                ...
                                render={({ field, fieldState }) => (
                                    <Field data-invalid={fieldState.invalid}>
                                        ...
                                        <Input
                                            ...
                                            aria-invalid={fieldState.invalid}
                                        />
                                        <div className="text-[0.8rem] text-muted-foreground">Alerta si baja de este valor</div>
                                        {fieldState.invalid && fieldState.error && (
                                            <FieldError errors={[fieldState.error]} />
                                        )}
                                    </Field>
