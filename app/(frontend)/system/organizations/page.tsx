  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          {/* CAMBIO: Texto blanco para fondo oscuro */}
      ...
      <div className="flex items-center space-x-2">
        <div className="relative w-full max-w-sm">
          ...
          <Input
            ...
            className="pl-8 bg-slate-950 border-slate-800 text-white placeholder:text-slate-500 focus-visible:ring-indigo-500"
          />
        </div>
      </div>

      {/* Table */}
      {/* CAMBIO: Borde oscuro y fondo oscuro */}
      <div className="rounded-md border border-slate-800 bg-slate-950 shadow-sm">
        <Table>
          <TableHeader>
            {/* CAMBIO: Hover oscuro */}
          ...
          <TableBody>
            {tenants.map((tenant) => (
              <TableRow
                key={tenant.id}
                className="hover:bg-slate-900 border-slate-800"
              >
